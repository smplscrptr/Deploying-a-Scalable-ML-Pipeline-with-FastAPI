...
path_encoder = os.path.join("model", "encoder.pkl") # TODO: enter the path for the saved encoder 
encoder = load_model(path_encoder)

path_model = os.path.join("model", "model.pkl") # TODO: enter the path for the saved model 
